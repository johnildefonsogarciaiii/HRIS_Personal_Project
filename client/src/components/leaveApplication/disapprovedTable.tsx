...
export default function DisapprovedTable() {
  ...
  const disapprovedLeave = userFilteredLeave.filter(
    (data: object) => data.status === "disapproved"
  );
